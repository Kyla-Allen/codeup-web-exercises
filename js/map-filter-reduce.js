...
let outputString = "Your instructors are: ";
const nameOfUsers = users.reduce((overall, current) => {
    outputString += `${current.name}, `;
    return outputString
}, " ");
